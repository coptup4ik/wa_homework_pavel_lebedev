...
function trafficLightToggle() {
    var trafficLightRed = document.querySelector('.trafficLight__light-red');
    var trafficLightGreen = document.querySelector('.trafficLight__light-green');
    var trafficLightYellow = document.querySelector('.trafficLight__light-yellow');
